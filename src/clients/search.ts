...
export class SearchIndexClient {
  ...
  async searchIndex<T>(index: string, query: string, params?: FilterParams): Promise<PagedResult<T>> {
    ...
    if (params?.sort) searchQuery.body.sort = [{ [params?.sort === 'title' ? 'title.raw' : params?.sort]: params.order || DEFAULT_ORDER }, '_score']
